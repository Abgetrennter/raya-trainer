...
using RayaTrainer.Host.Web.WebSockets;
    ...
    public static IEndpointRouteBuilder MapTrainerApiEndpoints(this IEndpointRouteBuilder endpoints)
    {
            ...
            TrainerApiHandler handler) =>
        {
            ...
            return result is not null
                ? Results.Ok(result)
                : TrainerApiErrors.CommandResult(
                    TrainerErrorVocabulary.WebSelectedUnitUnavailable,
                    "无法读取选中单位信息。");
        });
            ...
            TrainerApiHandler handler) =>
        {
            ...
            {
                return TrainerApiErrors.CommandResult(
                    TrainerErrorVocabulary.WebCapabilityNotReady,
                    capability.Reason);
            }
            ...
            {
                return TrainerApiErrors.CommandResult(
                    TrainerErrorVocabulary.WebUnitUpgradeReadFailed,
                    "无法读取单位升级信息。请确认已选中一个单位。");
            }
