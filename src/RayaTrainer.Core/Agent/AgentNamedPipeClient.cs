...
public sealed partial class AgentNamedPipeClient : IAgentClient
{
    ...
    public Task<AgentSelectedObjectIdsPayload> GetSelectedObjectIdsAsync(
        int processId,
        TimeSpan timeout,
        CancellationToken cancellationToken = default)
    {
        return SendCommandAsync(
            processId,
            AgentCommand.GetSelectedObjectIds,
            [],
            timeout,
            AgentSelectedObjectIdsPayload.ReadFrom,
            cancellationToken);
    }

    public Task<AgentAscensionPoliciesPayload> GetAscensionPoliciesAsync(
        int processId,
        TimeSpan timeout,
        CancellationToken cancellationToken = default)
    {
        return SendCommandAsync(
            processId,
            AgentCommand.GetAscensionPolicies,
            [],
            timeout,
            AgentAscensionPoliciesPayload.ReadFrom,
            cancellationToken);
    }

    public Task<AgentCommandResultPayload> SetOverlayStateAsync(
        int processId,
    ...
    public Task<AgentOverlayStatusPayload> GetOverlayStatusAsync(
        int processId,
        TimeSpan timeout,
        CancellationToken cancellationToken = default)
    {
        return SendCommandAsync(
            processId,
            AgentCommand.GetOverlayStatus,
            [],
            timeout,
            AgentOverlayStatusPayload.ReadFrom,
            cancellationToken);
    }
