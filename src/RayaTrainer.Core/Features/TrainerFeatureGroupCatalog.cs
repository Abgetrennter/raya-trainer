...
public static class TrainerFeatureGroupCatalog
{
    ...
    [
        ...
        new("伤害与无敌", ["玩家全建筑/单位无敌", "一击必杀敌方建筑物/单位"], false),
        new("选中单位 · 生命值", ["选择的建筑物/单位无限生命值", "选择的建筑物/单位生命值变为1", "选择的建筑物/单位恢复原本的生命值", "设置选中建筑物/单位生命值为指定值"]),
        new("选中单位 · 速度", ["选择的单位高速移动", "选择的单位缓慢移动", "选择的单位暂停", "选择的单位恢复速度"]),
        new("选中单位 · 其他", ["选择的单位快速升级", "移动选中单位到鼠标位置", "选择的单位满攻速（切换，仅当前实例）", "选择的单位弹药填满", "选择的单位弹药归1", "俘虏选择的建筑物/单位", "摧毁选择的建筑物/单位", "选择的建筑物/单位设置伪装状态"]),
        new("其他操作", ["威胁等级最大", "威胁等级归零", "威胁等级恢复原状", "选择的矿脉恢复采集矿量", "允许后台响应（失焦时修改器仍可响应，仅限单机/遭遇战）"], false)
    ];
