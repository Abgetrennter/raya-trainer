...
public static class TrainerFeatureIds
{
    ...
    // 属性修改页（Ascension）整表应用 / 全部还原：App 侧动作热键（游戏前台经键盘钩子触发）。
    public const string AscensionApply = "AscensionApply";
    public const string AscensionRestore = "AscensionRestore";
    ...
    // 战场支援产品（统一属性修改体系阶段 D）：精兵学院（生产升星）、车库（治疗光环）、将军刽子手生成、矿脉生成。
    ...
    public const string ProductSpawnArsenalMcv = "Product Spawn Arsenal MCV";
    public const string ProductSpawnOreNode = "Product Spawn Ore Node";
}
