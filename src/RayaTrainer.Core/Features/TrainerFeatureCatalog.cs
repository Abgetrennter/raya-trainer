...
public static class TrainerFeatureCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, FeatureOverride> SourceTrainerOverrides =
        new Dictionary<string, FeatureOverride>(StringComparer.Ordinal)
        {
            ...
            // 速度四模式已退役（计划 Phase 4 实机 Gate 通过）：正式入口改为
            // selected-unit.speed.fast/.slow/.freeze/.restore 产品（Overlay/产品控制台/Web）。
            ["Select Unit Super Speed"] = new(null, null, null, null, null, true),
            ["Select Unit Slow Speed"] = new(null, null, null, null, null, true),
            ["Select Unit Freeze"] = new(null, null, null, null, null, true),
            ["Restore Select Unit Speed"] = new(null, null, null, null, null, true),
    ...
    // 满攻速/射程切换与清除 feature 已随攻速/射程 flag 路径退役（迁移计划 Phase 5，
    // ADR 0027 门通过）：正式入口为 attack-speed/.attack-range enable/disable 与
    // effects.clear-* 产品。

    // ── Product Intent features（统一属性修改体系阶段 D）─────────────────────────────
    // DisplayName 与产品目录 displayName 严格一致；点击后不走 Direct GameApi，而是由
    // App 经产品控制会话提交 Product Intent，与 Overlay/Web 同一执行路由。
    private static readonly TrainerFeature[] ProductIntentFeatures =
    [
        new(TrainerFeatureIds.ProductSpeedFast,          "选择的单位高速移动", null, [], null, null),
        new(TrainerFeatureIds.ProductSpeedSlow,          "选择的单位缓慢移动", null, [], null, null),
        new(TrainerFeatureIds.ProductSpeedFreeze,        "选择的单位暂停", null, [], null, null),
        new(TrainerFeatureIds.ProductSpeedRestore,       "选择的单位恢复速度", null, [], null, null),
        new(TrainerFeatureIds.ProductMoveSpeedCustom,    "选择的单位移速（自定义倍率）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackSpeedEnable,  "选择的单位满攻速（无限射速）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackSpeedDisable, "选择的单位满攻速（停用）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackSpeedCustom,  "选择的单位攻速（自定义倍率）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackRangeEnable,  "选择的单位无限射程与索敌（启用）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackRangeDisable, "选择的单位无限射程与索敌（停用）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackRangeCustom,  "选择的单位射程（自定义倍率）", null, [], null, null),
        new(TrainerFeatureIds.ProductAttackDamageCustom, "选择的单位伤害（自定义倍率）", null, [], null, null),
        new(TrainerFeatureIds.ProductMaxHealthCustom,    "选择的单位生命（自定义倍率）", null, [], null, null),
        new(TrainerFeatureIds.ProductClearAttackSpeed,   "清除所有单位的满攻速效果", null, [], null, null),
        new(TrainerFeatureIds.ProductClearAttackRange,   "清除所有单位的无限射程效果", null, [], null, null),
        // 战场支援：精兵学院（生产升星）/ 车库（治疗光环）/ 将军刽子手生成 / 矿脉生成。
        new(TrainerFeatureIds.ProductVeterancyGrant,     "生产升星授予", null, [], null, null),
        new(TrainerFeatureIds.ProductHealingAuraEnable,  "全军治疗光环", null, [], null, null),
        new(TrainerFeatureIds.ProductHealingAuraDisable, "移除治疗光环", null, [], null, null),
        new(TrainerFeatureIds.ProductSpawnMechaKing,     "生成将军刽子手", null, [], null, null),
        new(TrainerFeatureIds.ProductSpawnArsenalMcv,    "生成军械库基地车", null, [], null, null,
            SupportedProfileIds: ["ra3_1.12"]),
        new(TrainerFeatureIds.ProductSpawnOreNode,       "生成矿脉", null, [], null, null),
    ];
    ...
    private static readonly TrainerFeature FrameRateUnlockFeature =
        new(
            ...
            null,
            null,
            SupportedProfileIds: ["ra3_1.12", "ra3_1.13"]);
