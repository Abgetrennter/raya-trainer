...
internal static class Ra3_1_13_Profile
{
    ...
    private static IReadOnlyDictionary<int, int> BuildVerifiedHookRvas()
    {
        return new Dictionary<int, int>
        {
            ...
            [0x2F8FE0] = 0x322190,
            // WeaponTemplate_GetEffectiveRange (sub_6F9460 in 1.12). Signature
            // 51 53 8B 5C 24 0C 85 DB 55 56 57 89 4C 24 10 matches uniquely at 0x722610.
            [0x2F9460] = 0x322610
        };
    }
    ...
    private static IReadOnlyDictionary<int, byte[]> BuildExpectedHookBytes()
    {
        return new Dictionary<int, byte[]>
        {
            ...
            // GetEffectiveRange 6-byte prologue: push ecx; push ebx; mov ebx,[esp+0Ch]
