...
public sealed class TrainerApiHandler
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new ProductControlContextResponse(
            ...
            context.SinglePlayerProof == SinglePlayerProof.Proven,
    ...
    private static ProductControlContextResponse OfflineContext(ProductControlStatusInfo status) =>
        new(status, false, MatchLifecycle.Unavailable.ToString(), false,
            RuntimeFlags.None.ToString(), ScopeMask.None.ToString(), false, 0, 0, 0);
