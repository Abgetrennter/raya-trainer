...
public sealed class FeatureItemViewModel : ViewModelBase
{
    ...
    public string ParameterKind => Feature.RawName switch
    {
        ...
        // 选中单位页参数输入（SelectedUnitPage 数据触发判别键）
        TrainerFeatureIds.SetSelectedUnitTargetHealth => "TargetHealth",
        TrainerFeatureIds.ProductMoveSpeedCustom => "MoveSpeedCustom",
        TrainerFeatureIds.ProductAttackSpeedCustom => "AttackSpeedCustom",
        TrainerFeatureIds.ProductAttackRangeCustom => "AttackRangeCustom",
        TrainerFeatureIds.ProductAttackDamageCustom => "AttackDamageCustom",
        TrainerFeatureIds.ProductMaxHealthCustom => "MaxHealthCustom",
        _ => string.Empty,
    };
