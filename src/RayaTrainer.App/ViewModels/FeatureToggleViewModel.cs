...
public sealed class FeatureToggleViewModel : ViewModelBase
{
    ...
    /// <summary>生成矿脉的朝向输入（整数度）；惰性读取，点击执行时由 MainViewModel 校验。默认 45° 对应官方地图的对角摆放。</summary>
    public string OreNodeAngleText { get; set; } = "45";

    public string OreNodeAngleHelpText => "矿脉朝向角度（度，-360~360）：0=朝东，逆时针为正；官方地图多用 45、135、-45、-135。";
